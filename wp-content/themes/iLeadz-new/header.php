...
$(document).ready(function() {
  ...
  var now = new Date();    
	if((now.getHours() >= 0) && (now.getHours() < 12)) { $('#goe h2 b').html("Goedemorgen."); }
	else if((now.getHours() >= 12) && (now.getHours() < 18)) { $('#goe h2 b').html("Goedemiddag."); }
	else { $('#goe h2 b').html("Goedenavond."); }
