 ...
 * The Header for our referencies page.
...
/*
  $('.main-menu li.special').on('click',function(e){
	...
	if($('#spec-menu').css("display")=="block" && first_enter ==1) {prepereHideSpecial();} else { 
...
<body <?php body_class(); ?>>
<!-- Google Tag Manager --><noscript><iframe src="//www.googletagmanager.com/ns.html?id=GTM-KNH42N"height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='//www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-KNH42N');</script><!-- End Google Tag Manager -->
...
<div id="site-top">
  ...
  <?php if ((get_post_meta($post->ID, "gray-title", true)) || (get_post_meta($post->ID, "gray-text", true))) { ?>   
    
    <div id="sss" class="text-only">
    <div id="sss-align">
    
  
    
     <h2><?php echo get_post_meta($post->ID, "gray-title", true); ?></h2>
    
    <?php echo get_post_meta($post->ID, "gray-text", true); ?>
