...
function te__settings(){
	add_thickbox();
        ...
        if ($_POST['save_gateway_settings']) {
			...
			update_option('special-1', $_POST['special-1']);
			update_option('special-2', $_POST['special-2']);
            update_option('special-3', $_POST['special-3']);
            update_option('special-4', $_POST['special-4']);
            update_option('special-5', $_POST['special-5']);
			...
			update_option('friend_email', $_POST['friend_email']);
			 ...
			 $special_1 = get_option('special-1','');
		 $special_2 = get_option('special-2','');
		  $special_3 = get_option('special-3','');
		   $special_4 = get_option('special-4','');
		    $special_5 = get_option('special-5','');
...
<h3 class="title">Sub Menu Titles</h3> 
...
<tr valign="top">
   <th scope="row"><label for="maak_text">Title 1</label></th>
   <td><input name="special-1" type="text" id="special-1" value="<?php echo $special_1;?>" class="regular-text code"></td>
</tr>
<tr valign="top">
   <th scope="row"><label for="maak_text">Title 2</label></th>
   <td><input name="special-2" type="text" id="special-2" value="<?php echo $special_2;?>" class="regular-text code"></td>
</tr>
<tr valign="top">
    <th scope="row"><label for="maak_text">Title 3</label></th>
   <td><input name="special-3" type="text" id="special-3" value="<?php echo $special_3;?>" class="regular-text code"></td>
</tr>
<tr valign="top">
  <th scope="row"><label for="groot_text">Title 4</label></th>
   <td><input name="special-4" type="text" id="special-4" value="<?php echo $special_4;?>" class="regular-text code"></td>
</tr>
<tr valign="top">
   <th scope="row"><label for="maat_text">Title 5</label></th>
   <td><input name="special-5" type="text" id="special-5" value="<?php echo $special_5;?>" class="regular-text code"></td>
</tr>
